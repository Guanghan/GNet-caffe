...
enum V1LayerParameter_LayerType {
  ...
  V1LayerParameter_LayerType_ROIPOOLING = 40
};
...
const V1LayerParameter_LayerType V1LayerParameter_LayerType_LayerType_MAX = V1LayerParameter_LayerType_ROIPOOLING;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.CPMDataParameter cpmdata_param = 140;
  inline bool has_cpmdata_param() const;
  inline void clear_cpmdata_param();
  static const int kCpmdataParamFieldNumber = 140;
...
class HDF5DataParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional bool debug = 4 [default = false];
...
// optional bool debug = 4 [default = false];
inline bool HDF5DataParameter::has_debug() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void HDF5DataParameter::set_has_debug() {
  _has_bits_[0] |= 0x00000008u;
}
inline void HDF5DataParameter::clear_has_debug() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void HDF5DataParameter::clear_debug() {
  debug_ = false;
  clear_has_debug();
}
inline bool HDF5DataParameter::debug() const {
  // @@protoc_insertion_point(field_get:caffe.HDF5DataParameter.debug)
  return debug_;
}
inline void HDF5DataParameter::set_debug(bool value) {
  set_has_debug();
  debug_ = value;
  // @@protoc_insertion_point(field_set:caffe.HDF5DataParameter.debug)
}
