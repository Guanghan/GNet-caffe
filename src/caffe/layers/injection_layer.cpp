...
#include "caffe/proto/caffe.pb.h" // declared cpmdata_param_
...
// Deconstructor
template <typename Dtype>
InjectDataLayer<Dtype>::~InjectDataLayer() {
    this->StopInternalThread();
  }


// Implement what has been promised in hpp file.
template <typename Dtype>
void InjectDataLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template<typename Dtype>
void InjectDataLayer<Dtype>::load_batch(Batch<Dtype>* batch) {
...
INSTANTIATE_CLASS(InjectDataLayer);
REGISTER_LAYER_CLASS(InjectData);
